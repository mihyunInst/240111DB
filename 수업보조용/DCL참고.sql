...
SELECT * FROM kh_cmh.EMPLOYEE;
--SELECT * FROM kh_cmh.DEPARTENT; 
--> DEPARTENT 테이블은 권한 주지 않아서 안됨
...
AS SELECT * FROM kh_cmh.EMPLOYEE;
...
-- CASCADE : cmh_sample 사용자에 속한 모든 객체(테이블, 뷰 등)를 함께 삭제
DROP USER cmh_sample CASCADE;


-- ALL_USERS : 만들어진 USER 객체를 전부 확인하는 딕셔너리 뷰
